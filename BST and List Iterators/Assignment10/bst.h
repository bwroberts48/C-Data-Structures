...
public:
	...
	inline InOrderIterator<T> InOrderIterBegin();
	inline PostOrderIterator<T> PostOrderIterBegin();
	inline PreOrderIterator<T> PreOrderIterBegin();
	inline BreadthFirstIterator<T> BreadthFirstIterBegin();
...
template <typename T>
inline InOrderIterator<T> BST<T>::InOrderIterBegin()
{
	InOrderIterator<T> iter(m_root);
	return iter;
}

template <typename T>
inline PostOrderIterator<T> BST<T>::PostOrderIterBegin()
{
	PostOrderIterator<T> iter(m_root);
	return iter;
}

template <typename T>
inline PreOrderIterator<T> BST<T>::PreOrderIterBegin()
{
	PreOrderIterator<T> iter(m_root);
	return iter;
}

template <typename T>
inline BreadthFirstIterator<T> BST<T>::BreadthFirstIterBegin()
{
	BreadthFirstIterator<T> iter(m_root);
	return iter;
}
